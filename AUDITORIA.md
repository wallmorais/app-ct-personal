...
| BUG-07 | Schema SQL do Supabase (`supabase/migrations/001_initial_schema.sql`) está desatualizado e não é usado pelo app — dados vivem só em `localStorage` | Média (arquitetural) |
